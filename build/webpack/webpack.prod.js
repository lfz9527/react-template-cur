...
const {ANALYZER_HOST = 'localhost', ANALYZER_PORT = '8080', ANALYZER} = require(
    paths.devConfig
)
const {getClientEnvironment, isProduction} = require('../config/env')
const {stringified} = getClientEnvironment(paths.publicUrlOrPath)
const isProd = isProduction(stringified['process.env'])
